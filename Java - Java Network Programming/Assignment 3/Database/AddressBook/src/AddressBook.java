...
public class AddressBook extends JFrame {
   ...
   public AddressBook() 
   {
      ...
      // create database connection + all prepared statements
      try {
   ...
   private class NewAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
         ...
         // set new AddressBookEntry in window and pass blank bean
   ...
   private class SaveAction extends AbstractAction {
      ...
      public void actionPerformed( ActionEvent e )
      {
         ...
         // obtain AddressBookEntry from window through the bean!!!!
         ...
         try {
            ...
            // insert or update entry   check for return code
            if ( personID == 0 )         
               database.newPerson( person );  //insert
            else
               database.savePerson( person );  //update
   ...
   private class SearchAction extends AbstractAction {
      ...
      {
         String lastName = 
            JOptionPane.showInputDialog( desktop, "Enter last name" );
         ...
         // do nothing
            ...
            if (lastName != null) {
               ...
               if (person != null) {
                  ...
                  // create window to display AddressBookEntry and passes bean with data
                  AddressBookEntryFrame entryFrame =
                          createAddressBookEntryFrame();
